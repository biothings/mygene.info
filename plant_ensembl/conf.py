# -*- coding: utf-8 -*-
#
# biothings.api documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'biothings.tex', u'BioThings SDK Documentation',
   u'BioThings team', 'manual'),
]
...
man_pages = [
    (master_doc, 'biothings', u'BioThings SDK Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'biothings', u'BioThings SDK Documentation',
   author, 'biothingsapi', 'One line description of project.',
   'Miscellaneous'),
]
