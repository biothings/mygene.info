# -*- coding: utf-8 -*-
#
# MyGene.info documentation build configuration file, created by
...
htmlhelp_basename = "MyGeneinfodoc"
...
latex_documents = [
    ("index", "MyGeneinfo.tex", "MyGene.info Documentation", "Chunlei Wu", "manual"),
]
...
man_pages = [("index", "mygeneinfo", "MyGene.info Documentation", ["Chunlei Wu"], 1)]
...
def setup(app):
    app.add_js_file("mygene_doc.js")
    app.add_js_file("jquery.dataTables.min.js")
    app.add_css_file("mygene_doc.css")
