...
project = u'MyGene.info'
copyright = u'2013, Chunlei Wu'
...
latex_documents = [
  ('index', 'MyGeneinfo.tex', u'MyGene.info Documentation',
   u'Chunlei Wu', 'manual'),
]
...
man_pages = [
    ('index', 'mygeneinfo', u'MyGene.info Documentation',
     [u'Chunlei Wu'], 1)
]
...
texinfo_documents = [
  ('index', 'MyGeneinfo', u'MyGene.info Documentation',
   u'Chunlei Wu', 'MyGeneinfo', 'MyGene.info : Gene Annotation Query as a Service.',
   'Miscellaneous'),
]
